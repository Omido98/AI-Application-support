...
Releases are published by CI (`.github/workflows/release.yml`) when a `v*`
tag is pushed. Never release directly from `main` — the release flow is:
...
4. Open a pull request into `main` and stop — the user tests the release and
